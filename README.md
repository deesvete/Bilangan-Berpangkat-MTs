...
<html lang="id">
    ...
    <style>
      * {
      ...
      body {
        ...
        margin: 0;
        background: linear-gradient(135deg, #f8b7f3, #16263a);
        color: #eaf6ff;
        min-height: 100vh;
      }
      header {
  ...
  <body>
    ...
    <main>
      <div id="homePage" class="container">
        <div class="card">
          ...
          <p>
            Materi ini membahas pengertian, bentuk umum, sifat-sifat, contoh
            dalam kehidupan sehari-hari, latihan soal beserta penjelasannya, dan
            disertai animasi interaktif untuk memudahkan pemahaman.
          </p>
          <a
            href="https://www.canva.com/design/DAG1AOBL_d0/jRYMYHe8Z-g_pHJWUkQ3bw/edit?utm_content=DAG1AOBL_d0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"
            target="_blank"
            class="link-btn"
            >Lihat di Canva</a
          >
    ...
    <script>
      const quizData = [
        { question: "1. a^5 = ?", answer: "axaxaxaxa" },
        { question: "2. Nilai dari (-3)^4 = ?", answer: "81" },
        { question: "3. Hasil perkalian 4^(-5)xs4^3 = ?", answer: "1/16" },
        {
          question: "4. Bentuk sederhana dari 8^15:8^5:8^3 = ?",
          answer: "8^7",
        },
        {
          question: "5. Hasil dari (-4)^3+(-4)^2+(-4)^1+(-4)^0 = ?",
          answer: "-51",
        },
        { question: "6. Hasil dari 2^(-1)+3^(-1) = ?", answer: "5/6" },
        {
          question: "7. Nilai bentuk sederhana dari 6^5/6^3 = ?",
          answer: "36",
        },
        {
          question: "8. Sederhanakan bentuk (2^3×5^2 )^2 = ?",
          answer: "2^6×5^4",
        },
        { question: "9. Hasil dari (4^2 )^3 = ?", answer: "4096" },
        { question: "10. Sederhanakan bentuk 5^7÷5^3 = ?", answer: "625" },
      ];
